...
$course = mysqli_query($koneksi, "select * from data_course  where id_course='$id_course'");
...
<body>
    ...
    <!-- end -->  
        ...
        <input type="hidden" value="<?php echo $row['id_course']; ?>" name="id_course">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="durasi" name="durasi" value="<?php echo $row['durasi']; ?>">
            </div>
